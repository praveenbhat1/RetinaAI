            ...
            <section className="relative pt-32 pb-20 overflow-hidden">
                <div className="container mx-auto px-6 relative z-10 max-w-4xl text-center">
                    ...
                    <motion.h1 {...fadeUp(0.1)} className="text-4xl md:text-7xl font-bold text-slate-900 tracking-tight mb-8 leading-tight">
                        Advancing <span className="text-slate-400 font-light italic">Retinal</span> Diagnostics
                    </motion.h1>
                    <motion.p {...fadeUp(0.2)} className="text-lg md:text-xl text-slate-500 max-w-2xl mx-auto leading-relaxed font-medium">
                        RetinaAI leverages high-precision convolutional neural networks trained on clinical fundus datasets to enable early, autonomous detection of diabetic retinopathy.
                    </motion.p>
                </div>
            </section>
                    ...
                    <div className="grid md:grid-cols-2 gap-20 items-center">
                        <motion.div {...fadeUp()}>
                            ...
                            <p className="text-slate-500 text-lg leading-relaxed mb-8 font-medium">
                                RetinaAI bridges the specialist gap by providing an AI-powered screening architecture deployable in any clinical node — delivering expert-level analysis in seconds.
                            </p>
