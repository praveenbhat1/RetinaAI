...
const PRINCIPLES = [
    ...
    },
    {
        ...
        content: "RetinaAI is currently a research and screening tool and is not approved by the FDA, CE, or any other regulatory body as a standalone medical device for clinical diagnosis. It should only be used as an adjunct screening aid within the scope of clinical research, educational demonstrations, or preliminary screening workflows under the supervision of qualified healthcare providers.",
                    ...
                    <motion.div {...fadeUp()} className="flex items-start gap-4 p-6 rounded-2xl bg-red-50 border border-red-200">
                        ...
                        <div>
                            ...
                            <p className="text-red-700 text-sm leading-relaxed">
                                <strong>RetinaAI does not provide medical diagnoses.</strong> All AI-generated screening results are probabilistic assessments and must be confirmed by a qualified medical professional. Never make treatment decisions based solely on AI screening outputs.
                            </p>
                        </div>
                    </motion.div>
                </div>
