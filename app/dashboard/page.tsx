            ...
            <div className="flex-1 bg-white py-24 px-6 relative overflow-hidden min-h-screen font-body">
                ...
                <div className="container mx-auto max-w-6xl relative z-10">
                            ...
                            return (
                                ...
                                >
                                    <div className="flex items-center justify-between mb-4">
                                        <div className="w-10 h-10 rounded-xl bg-slate-50 border border-slate-100 flex items-center justify-center text-slate-900 group-hover:scale-110 transition-transform">
                    ...
                    <div className="relative">
                        ...
                        {/* Pass doctorMode=true for doctors */}
                        <UploadCard doctorMode={isDoctor} />
                    </div>
